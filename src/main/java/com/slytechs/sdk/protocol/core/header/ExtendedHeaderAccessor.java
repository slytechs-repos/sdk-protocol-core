 ...
 * @since 1.0
 */
public interface ExtendedHeaderAccessor {
	 ...
	 * @see #isPresent(int)
	 */
	default HeaderExtension getExtension(int id) throws HeaderNotFoundException {
		return getExtension(id, 0);
	}
	 ...
	 */
	default HeaderExtension getExtension(int id, int depth) throws HeaderNotFoundException {
		throw new HeaderNotFoundException();
	}
	 ...
	 * @see #getExtension(Header, int)
	 * @see #hasExtension(Header)
	 */
	default <T extends HeaderExtension> T getExtension(T header) throws HeaderNotFoundException {
		return getExtension(header, 0);
	}
	 ...
	 * @throws HeaderNotFoundException if the header is not present at the specified
	 *                                 depth
	 * @see #hasExtension(Header, int)
	 */
	default <T extends HeaderExtension> T getExtension(T header, int depth) throws HeaderNotFoundException {
		throw new HeaderNotFoundException();
	}
	 ...
	 * @see #hasExtension(Header, int)
	 * @see #getExtension(Header)
	 */
	default boolean hasExtension(HeaderExtension header) {
		return hasExtension(header, 0);
	}
	 ...
	 * @see #getExtension(Header, int)
	 */
	default boolean hasExtension(HeaderExtension header, int depth) {
		return false;
	}
