...
import static com.slytechs.sdk.protocol.core.address.Addresses.*;
...
public record VlanIdRecord(byte[] bytes, int vlanId) implements VlanId {
	...
	/**
	 * @see com.slytechs.sdk.protocol.core.address.VlanId#setPcp(int)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.sdk.protocol.core.address.VlanId#setDei(boolean)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.sdk.protocol.core.address.VlanId#setVid(int)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.sdk.protocol.core.address.VlanId#setTci(int, boolean, int)
	 */
	@Override
