...
public abstract class AbstractProtocolPack implements ProtocolPack {
	...
	/**
	 * @see com.slytechs.sdk.protocol.core.pack.ProtocolPack#isLoaded()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.sdk.protocol.core.pack.ProtocolPack#setEnable(boolean)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.sdk.protocol.core.pack.ProtocolPack#id()
	 */
	@Override
	public final int id() {
		return id;
