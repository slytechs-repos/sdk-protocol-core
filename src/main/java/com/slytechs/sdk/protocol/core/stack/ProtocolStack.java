...
public class ProtocolStack {
     ...
     * 
     * <p>
     * IP reassembly, TCP reassembly, and TLS decryption are enabled with
     * default settings. Configure individual protocols for custom settings.
     * </p>
     *
    ...
    /** Packet-level policy configuration. */
    private final PacketPolicy packetPolicy;
    ...
    public ProtocolStack() {
        this.packetPolicy = PacketPolicy.zeroCopy(DescriptorInfo.NET, 0);
    }

    /**
     * Creates a new protocol stack with the specified packet policy.
     *
     * @param packetPolicy the packet policy to use
     */
    public ProtocolStack(PacketPolicy packetPolicy) {
        this.packetPolicy = Objects.requireNonNull(packetPolicy, "packetPolicy");
    }
    ...
    /**
     * Gets the packet policy configuration.
     *
     ...
     * 
     * <p>
     * Use when jumping to a new position in a capture file or when
     * resetting processing context.
     * </p>
     *
     * @return this stack for method chaining
     */
     ...
     * 
     * <p>
     * In quiet mode, processors update their state but don't emit tokens
     * or output. Use when rebuilding context after a file seek.
     * </p>
     *
     ...
     * 
     * <p>
     * The combined mask from all subscriptions determines which tokens
     * are generated. If no subscriptions, token generation is disabled
     * (zero cost).
     * </p>
     *
     ...
     * 
     * <p>
     * <b>Note:</b> This is temporary. Will be replaced by ProcessorTree
     * when the full tree building infrastructure is in place.
     * </p>
     *
     ...
     * 
     * <p>
     * Used when creating stream-specific stacks that may be modified
