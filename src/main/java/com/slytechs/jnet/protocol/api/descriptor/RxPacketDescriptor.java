...
/**
 * Provides RX-specific metadata for packets. Maps to DPDK (rte_mbuf.ol_flags
 * for checksums), Napatech (descriptor errors), Pcap (computed).
 *
