...
//			return Math.min(2, currentCaplen); // Frame Control at bytes 0-1
	...
	/**
	 * @see com.slytechs.jnet.protocol.api.dissector.PacketDissector#l2FrameType()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.protocol.api.dissector.PacketDissector#writeDescriptor(com.slytechs.jnet.protocol.api.descriptor.PacketDescriptor)
	 */
	@Override
